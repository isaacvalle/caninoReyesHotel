                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="mother_last_name" type="text" class="form-control{{ $errors->has('mother_last_name') ? ' is-invalid' : '' }}" name="mother_last_name" value="{{ old('mother_last_name') }}" required autofocus>
